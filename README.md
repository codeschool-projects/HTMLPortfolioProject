...
2. Using classes to organize your page and tie in styles,
3. Using headings to denote importance,
4. Adding text using paragraphs,
5. Creating links so users can contact you,
